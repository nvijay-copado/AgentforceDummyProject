...
import { OMNIDEF } from './type2Subtype2English_def.js';
import tmpl from './type2Subtype2English.html';
import tmpl_nds from './type2Subtype2English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class type2Subtype2English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
