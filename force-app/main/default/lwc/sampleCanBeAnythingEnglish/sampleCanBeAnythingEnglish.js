...
import { OMNIDEF } from './sampleCanBeAnythingEnglish_def.js';
import tmpl from './sampleCanBeAnythingEnglish.html';
import tmpl_nds from './sampleCanBeAnythingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sampleCanBeAnythingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
