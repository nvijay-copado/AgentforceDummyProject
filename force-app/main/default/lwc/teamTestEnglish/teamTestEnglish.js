...
import { OMNIDEF } from './teamTestEnglish_def.js';
import tmpl from './teamTestEnglish.html';
import tmpl_nds from './teamTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class teamTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
