...
import { OMNIDEF } from './contractLegalEnglish_def.js';
import tmpl from './contractLegalEnglish.html';
import tmpl_nds from './contractLegalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class contractLegalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
