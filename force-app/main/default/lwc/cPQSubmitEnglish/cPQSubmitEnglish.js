...
import { OMNIDEF } from './cPQSubmitEnglish_def.js';
import tmpl from './cPQSubmitEnglish.html';
import tmpl_nds from './cPQSubmitEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQSubmitEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
