...
import { OMNIDEF } from './demoMultiplayBuyFlowEnglish_def.js';
import tmpl from './demoMultiplayBuyFlowEnglish.html';
import tmpl_nds from './demoMultiplayBuyFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoMultiplayBuyFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
